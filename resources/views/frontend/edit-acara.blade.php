...
@section('JudulHalaman','Create Event')
...
<div class="container mt-4">
    <form id="buatAcara" method="POST" action="{{route('edit_acara',['id'=>$data['acara']->id])}}"
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control border-radius-c" value="{{$data['acara']->name}}"
                        name="nama_acara" placeholder="Nama Acara" required>
                </div>
                <div class="form-group date">
                    <input type="text" autocomplete="off" class="form-control border-radius-c datepicker" name="tanggal"
                        placeholder="Tanggal Acara" required value="{{$data['acara']->date}}">
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-10 col-sm-10 col-md-10 col-xl-10 col-lg-10 pr-4">
                            <input type="number" class="form-control border-radius-c" name="jumlah"
                                placeholder="Jumlah Peserta" required value="{{$data['acara']->capacity}}">
                        </div>
                        <div
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control border-radius-c" name="nama_instansi"
                        placeholder="Nama Instansi*" required value="{{$data['sertifikat']->nama_instansi}}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control border-radius-c" name="jenis_acara"
                        ...
                        value="{{$data['sertifikat']->jenis_sertifikat}}">
                </div>
                <div class="form-group">
                    <div class="preview-zone">
                        <div class="box box-solid">
                            ...
                            <div class="box-body mb-2">
                                <img width="200" src="{{asset($data['sertifikat']->logo_instansi)}}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="preview-zone">
                        <div class="box box-solid">
                            ...
                            <div class="box-body mb-2">
                                <img width="200" src="{{asset($data['sertifikat']->logo_sertifikat)}}">
                            </div>
                        </div>
                    </div>
                    <div class="dropzone-wrapper border-radius-c">
...
Karena telah mengikuti acara pelatihan JS 101 yang diselenggarakan oleh Team A">{{$data['sertifikat']->alasan}}</textarea>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                ...
                <fieldset {{!empty($data['properti_khusus']) ? "": "disabled"}}>
                    <div id="properti-tambahan">
                        ...
                        <div class="border border-radius-c p-2 mb-4" style="border-color: #495057;">
                            <p class="text-normal d-flex">
                                ...
                                <button type="button"
                                    class="ml-auto btn btn-danger btn-sm remove-preview btn-hapus-blok-khusus">
                                    <i class="fa fa-times"></i> Hapus
                                </button>
                            </p>
                            <p class="text-normal">
                            ...
                            <div class="row">
                                <div class="col-10 ml-auto mr-auto">
                                    ...
                                    <div class="form-group">
                                        <div class="preview-zone {{$d->gambar == "" ? "hidden":""}}">
                                            <div class="box box-solid">
                                                <div class="box-header with-border">
                                                    <div><b>Preview</b></div>
                                                    <div class="box-tools pull-right">
                                                ...
                                                <div class="box-body {{$d->gambar == "" ? "":"mb-2"}}">
                                                    <img width="200"
                                                        src="{{$d->gambar != "" ? asset($d->gambar) : ""}}">
                                                </div>
                                            </div>
                                            <input type="hidden" name="khusus_gambar_temp[]" value="gnosok_in">
                                        </div>
                                        <div class="dropzone-wrapper border-radius-c">
                                            <div class="dropzone-desc" style="width: 90%;">
