...
<div class="container mt-4">
    ...
    <div class="row mt-auto mb-auto">
        <div
            class="col-12col-11 col-sm-11 col-md-12 col-lg-12 col-xl-12 m-auto border border-radius-c border-hijau px-2 py-2 shadow">
    ...
    <div class="row">
        <div
            class="col-11 col-sm-11 col-md-12 col-lg-12 col-xl-12 m-auto border border-radius-c border-hijau px-2 py-2 shadow">
    ...
    <form action="{{route('peserta_daftar_link',['id'=>$data['id']])}}" method="POST">
        ...
        <div class="row d-flex mt-4">
            <button type="submit" class="btn m-auto btn-outline-success shadow">Daftar</button>
        </div>
    </form>
</div>
@endif
